  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Rekayasa Perangkat Lunak</div>
        <div class="card-body">
          <h5 class="card-title">Student At SMKN 1 WONOSOBO</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">JL Bhayangkara No.12, Puntuk Sari, Wonosobo</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">WidyaPustaka</a>  2025</p>
        </div>
      </div>
    </footer>
